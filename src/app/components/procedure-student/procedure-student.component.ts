...
@Component({
  selector: 'app-procedure-student',
  templateUrl: './procedure-student.component.html',
  styleUrls: ['./procedure-student.component.css']
})

// export class ProcedureListComponent implements OnInit {
export class ProcedureStudentComponent implements OnInit {
//---
